  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-6 text-gray-700 font-medium">
        ...
        { user ? <UserButton/> : 
          <button onClick={() => openSignIn()} className="bg-blue-600 hover:bg-blue-700 transition-colors duration-200 text-white px-5 py-2 rounded-md shadow-sm">
          Create Account
        </button>}
      </div>
      ...
      <div className="md:hidden flex items-center gap-3 text-gray-700">
        ...
        <button className="ml-1">
          <FaUserCircle size={24} className="text-gray-600 hover:text-blue-600 transition-colors duration-200" />
        </button>
      </div>
    </div>
  );
